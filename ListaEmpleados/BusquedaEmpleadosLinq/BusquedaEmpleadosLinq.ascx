...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BusquedaEmpleadosLinq.ascx.cs" Inherits="ListaEmpleados.BusquedaEmpleadosLinq.BusquedaEmpleadosLinq" %>
...
<asp:ListView ID="lstEmpleados" runat="server">
    ...
    <ItemTemplate>
        <tr runat="server">
            ...
            <td runat="server">
                <asp:Label runat="server" Text='<%# Eval("Puesto") %>'></asp:Label>
            </td>
            <td runat="server">
                <asp:Label runat="server" Text='<%# Eval("Fechadealta") %>'></asp:Label>
            </td>
        </tr>
    </ItemTemplate>
</asp:ListView>